    ...
    <section>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-5 mx-auto text-xl text-gray-800">
            Monster Blast Pty ltd built the Monster Blast app as a Free app.
            This SERVICE is provided by Monster Blast Pty ltd at no cost and is
            ...
            is accessible at Monster Blast unless otherwise defined in this
            ...
            us with certain personally identifiable information. The information
            ...
            Facebook One Signal Log Data We want to inform you that whenever you
            use our Service, in a case of an error in the app we collect data
            and information (through third party products) on your phone called
            Log Data. This Log Data may include information such as your device
            ...
            portions of this Service. Service Providers We may employ
            ...
            for any other purpose. Security We value your trust in providing us
            your Personal Information, thus we are striving to use commercially
            ...
            security. Links to Other Sites This Service may contain links to
            other sites. If you click on a third-party link, you will be
            directed to that site. Note that these external sites are not
            operated by us. Therefore, we strongly advise you to review the
            ...
            any third-party sites or services. Children’s Privacy These Services
            do not address anyone under the age of 13. We do not knowingly
            collect personally identifiable information from children under 13
            years of age. In the case we discover that a child under 13 has
            ...
            contact us so that we will be able to do necessary actions. Changes
            to This Privacy Policy We may update our Privacy Policy from time to
            ...
            2021-09-25 Contact Us If you have any questions or suggestions about
            our Privacy Policy, do not hesitate to contact us at
            support@beastblast.com.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-5 mx-auto text-xl text-gray-800">
            ...
            property rights related to it, still belong to Monster Blast Pty
            ltd. Monster Blast Pty ltd is committed to ensuring that the app is
            ...
            paying for. The Monster Blast app stores and processes personal data
            that you have provided to us, in order to provide our Service. It’s
            your responsibility to keep your phone and access to the app secure.
            ...
            mean that the Monster Blast app won’t work properly or at all. The
            app does use third party services that declare their own Terms and
            Conditions. Link to Terms and Conditions of third party service
            providers used by the app Google Play Services Facebook One Signal
            You should be aware that there are certain things that Monster Blast
            Pty ltd will not take responsibility for. Certain functions of the
            ...
            provider, but Monster Blast Pty ltd cannot take responsibility for
            the app not working at full functionality if you don’t have access
            to Wi-Fi, and you don’t have any of your data allowance left. If
            ...
            same lines, Monster Blast Pty ltd cannot always take responsibility
            ...
            it on to avail the Service, Monster Blast Pty ltd cannot accept
            responsibility. With respect to Monster Blast Pty ltd’s
            ...
            available to you. Monster Blast Pty ltd accepts no liability for any
            loss, direct or indirect, you experience as a result of relying
            wholly on this functionality of the app. At some point, we may wish
            to update the app. The app is currently available on Android, iOS &
            KaiOS – the requirements for system(and for any additional systems
            we decide to extend the availability of the app to) may change, and
            you’ll need to download the updates if you want to keep using the
            app. Monster Blast Pty ltd does not promise that it will always
            update the app so that it is relevant to you and/or works with the
            Android, iOS & KaiOS version that you have installed on your device.
            ...
            delete it from your device. Changes to This Terms and Conditions We
            may update our Terms and Conditions from time to time. Thus, you are
            advised to review this page periodically for any changes. We will
            notify you of any changes by posting the new Terms and Conditions on
            this page. These terms and conditions are effective as of 2021-09-25
            Contact Us If you have any questions or suggestions about our Terms
            and Conditions, do not hesitate to contact us at
            support@bestblast.com
          </p>
        </div>
      </div>
    </section>
